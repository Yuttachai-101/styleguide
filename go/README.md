...
| :-------------------------------------------- | :------------------------------------------------------------- | :---------------------------------- | :------------------------- | :------------------------ |
| **Style Guide** (คู่มือสไตล์)                 | [ลิงก์](https://google.github.io/styleguide/go/guide)          | ทุกคน                               | ใช่                        | ใช่                       |
| **Style Decisions** (การตัดสินใจเรื่องสไตล์)  | [ลิงก์](https://google.github.io/styleguide/go/decisions)      | Readability Mentors (ผู้ให้คำแนะนำ) | ใช่                        | ไม่                       |
| **Best Practices** (แนวทางปฏิบัติที่ดีที่สุด) | [ลิงก์](https://google.github.io/styleguide/go/best-practices) | ผู้ที่สนใจ                          | ไม่                        | ไม่                       |

---

### เอกสารประกอบ (Documents)

1.  **[Style Guide (คู่มือสไตล์)](https://google.github.io/styleguide/go/guide)**
    วางรากฐานของสไตล์ Go ที่ Google เอกสารนี้ถือเป็น **ข้อกำหนดหลัก** และใช้เป็นพื้นฐานสำหรับคำแนะนำในเอกสารอื่นๆ

2.  **[Style Decisions (การตัดสินใจเรื่องสไตล์)](https://google.github.io/styleguide/go/decisions)**
...
3.  **[Best Practices (แนวทางปฏิบัติที่ดีที่สุด)](https://google.github.io/styleguide/go/best-practices)**
